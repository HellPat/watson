...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getUriSignerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct('fixture', '_hash', '_expiration', NULL) && false ?: $lazyLoad);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'WatsonBundle' => 'Watson\\Symfony\\WatsonBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'WatsonBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/packages/symfony/src'),
                    'namespace' => 'Watson\\Symfony',
                ],
            ],
